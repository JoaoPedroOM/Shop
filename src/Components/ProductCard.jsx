...
const ProductCard = ({data}) => {
  ...
  return (
    <section
      className={`w-full max-w-[300px] bg-white flex flex-col cursor-pointer m-auto relative rounded ${
    ...
    >
      ...
      <div className="p-5 border-t border-solid border-[#ddd]">
        <h2 className="text-[30px] font-normal block mb-[10px]">{formatCurrency(price)}</h2>
